...
import useSkill from "../../store/skills";
import { TOKEN, USER, USER_ID } from "../../constants";
import Loading from "../../components/loading";
const Skills = () => {
  const [data, setSkill] = useState<Skill[] | null>(null);
  ...
  return (
    <div>
        ...
        <div className="container">
          ...
          <div className="container">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input name="percent" type="text" placeholder="percent"/>
      ...
      <section style={{paddingTop:"180px",marginBottom:"100px"}}>
        <h1 style={{color:"black",textAlign:"center",marginBottom:"25px"}}>Skills({total})</h1>
        <div className="container">
      {data?.map((item) => (
          <div className="col-12" style={{boxShadow:"-1px 0px 13px 10px rgba(34, 60, 80, 0.2)",padding:"8px 6px",borderRadius:"5px",marginBottom:"25px"}}>
            <div className="container">
              <div className="head" style={{display:"flex",gap:"10px"}}>
                <h1 style={{color:"black"}}>{item.name}</h1>
              </div>
              <div className="footer">
                <p style={{marginBottom:"5px"}}>{item.percent}%</p>
              </div>
            </div>
          </div>
      ))}
